  ...
  return (
      ...
      <div className=" flex flex-col bg-background min-h-screen w-full overflow-x-hidden box-border  ">
        ...
        <div className="  fixed border border-b-[1px] border-accent/60 flex justify-around items-center w-full py-3  animate__animated animate__fadeInDown bg-background/30 backdrop-blur-md z-10">
          <Link to="/react-vite-supreme" className=" flex  items-center gap-10 sm:gap-8">
          ...
          <nav className=" text-accent-foreground flex gap-10 sm:gap-5">
            ...
            <a className=" hover:underline hover:text-primary hover:decoration-primary/40 sm:text-xs  underline-offset-4 ease-out transition-all duration-200 animate__animated animate__faster animate__fadeInDown animate__delay-2s" href="/react-vite-supreme/contact">Work</a>
...
<div className= " absolute gradient  z-1  bottom-0 right-0 m-[10%]  "></div>
</div>
  ...
  <div className=" relative sm:absolute  flex h-[60%] flex-col justify-start gap-20 sm:gap-1 sm:right-0 mr-5 ">
    <div className=" flex flex-col  gap-1">
      ...
      <p
        ...
        className=" active:translate-y-2 animate__animated animate__fadeIn animate__delay-1s  hover:cursor-pointer hover:bg-primary/30 backdrop-blur-lg  hover:text-accent-foreground transition-all duration-200 font-inter  mt-7 sm:mt-3  text-lg flex items-center justify-center gap-2  sm:text-xs  text-primary w-[40%] sm:w-[60%]  rounded-md py-2 "
      >
        Download CV
